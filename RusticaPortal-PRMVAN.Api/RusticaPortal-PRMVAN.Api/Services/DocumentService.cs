...
namespace RusticaPortal_PRMVAN.Api.Services
{
    ...
    public async Task<AmountAvailableGetDTO> GetAmountAvailable(RequestInformation requestInformation, string nomSistem, string BaseDatos, string project)
    {
        ...
        public async Task<ResponseInformation> GetGestionAyudaDet(string empresa, string docEntry, string periodo, string? tienda)
        {
            if (!TryGetEmpresaConfig(empresa, out var cfg, out var error))
            {
                return error;
            ...
            try
            {
                ...
                cmd.Parameters.Add("@vParam3", HanaDbType.NVarChar, 50).Value = tienda ?? string.Empty;
                cmd.Parameters.Add("@vParam4", HanaDbType.NVarChar, 50).Value = string.Empty;
        ...
        public async Task<ResponseInformation> GetGestionAyudaBuscar(string empresa, string periodo, string? tienda)
        {
            ...
            var detalle = await GetGestionAyudaDet(empresa, docEntry, periodo, tienda);
