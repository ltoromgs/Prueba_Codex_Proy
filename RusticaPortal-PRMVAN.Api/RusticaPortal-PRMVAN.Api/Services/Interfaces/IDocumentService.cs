...
namespace ArellanoCore.Api.Services.Interfaces
{
    ...
    {
        public Task<ResponseInformation> PostInfo(RequestInformation requestInformation, string nomSistema, string BaseDatos);
        public Task<ResponseInformation> UpdateInfo(RequestInformation requestInformation, string nomSistem, string BaseDatos);
        ...
        public Task<ResponseInformation> DeleteInfo(RequestInformation requestInformation, string nomSistem, string BaseDatos, string docEntry);
