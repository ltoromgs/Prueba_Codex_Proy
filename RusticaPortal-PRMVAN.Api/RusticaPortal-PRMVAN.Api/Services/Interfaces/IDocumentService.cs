...
namespace RusticaPortal_PRMVAN.Api.Services.Interfaces
{
    public interface IDocumentService
    {
        ...
        Task<ResponseInformation> GetGestionAyudaDet(string empresa, string docEntry, string periodo, string? tiendas);
        Task<ResponseInformation> GetGestionAyudaBuscar(string empresa, string periodo, string? tiendas);
