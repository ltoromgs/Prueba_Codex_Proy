#pragma checksum "C:\Desarrollos Rustica\PRM Y VAN\CODEX\Prueba_Codex_Proy\RusticaPortal_PRMVAN.Web\Views\Factores\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "d28ea30ed9c895a824e4dca93c96a64573795dab"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"d28ea30ed9c895a824e4dca93c96a64573795dab", @"/Views/Factores/Index.cshtml")]
            ...
            WriteLiteral(@"p input-group-sm"">
                ...
                <div class=""table-responsive"" style=""max-height:60vh; overflow:auto;"">
                    <table class=""table table-sm table-hover table-bordered"" id=""tablaPreviewNuevo"" style=""white-space:nowrap;"">
                        <thead class=""table-light"">
                            <tr>
                                <th class=""d-none"" style=""min-width:110px;"">Cód.<br />interno</th>
                                <th class=""sticky-col-start"" style=""min-width:220px;"">Tienda<br />Nombre</th>
              ");
            WriteLiteral(@"                  <th>Meta<br />(UV)</th>
                                <th>Renta<br />(%)</th>
                                <th>VAN<br />(%)</th>
                                <th>PERS<br />(%)</th>
                                <th>Gtos<br />ADM (%)</th>
...
");
    ...
    <script>
      ...
      ");
                WriteLiteral(@"      if (!Array.isArray(lista) || lista.length === 0) {
        ...
        function stripPaste(e) {
            ...
            const text = (e.clipboardData |");
                WriteLiteral(@"| window.clipboardData).getData('text');
        ...
        function handleGridPaste(e) {
            ...
            rows.forEach((rowStr, r) => {
                ...
                cols.forEach((val) => {
           ");
                WriteLiteral(@"         const cell = rowEl.children[cIndex];
                    if (!cell) return;
        ...
        document.querySelectorAll('#tablaMatriz td.dec').forEach(td => {
            ...
            t");
                WriteLiteral(@"d.addEventListener('input', () => validateCell(td));
     ...
     ");
                WriteLiteral(@"       const placeholder = `
        ...
        document.getElementById('btnBuscar')?.addEventListener('click', async () => {
            ...
            try {
                ...
                if");
                WriteLiteral(@" (!res.ok) { showAlert(data.message || 'Error al buscar', 'danger'); return; }
                ...
                showAle");
                WriteLiteral(@"rt('No se pudo conectar con el servidor.', 'danger');
            }
        });
        ...
        <td contenteditable=""tru");
                WriteLiteral(@"e"" class=""dec"" data-field=""u_MGS_CL_ESTPER"">${m.u_MGS_CL_ESTPER ?? ''}</td>
        ...
        <td contenteditable=""true"" class=""dec"" data-field=""u_MGS_CL_CLIMA"">${m.u_");
                WriteLiteral(@"MGS_CL_CLIMA ?? ''}</td>
  ...
  ");
                WriteLiteral(@"          nuevoEstado.textContent = '';
        }
        ...
        function armarPreview(data) {
            previewData = (data || []).map(previo => {
                ...
                const nombre = previo.u_MGS_CL_NOMTIE ?? previo.U_MGS_CL_NOMTIE ?? obtenerNombreTienda(tienda);
   ...
   ");
                WriteLiteral(@"                 U_MGS_CL_REGALI: toNumberOrZero(previo.u_MGS_CL_REGALI ?? previo.U_MGS_CL_REGALI),
                    ...
                    U_MGS_CL_CLIMA: toNumberOrZero(previo.u_MGS_CL_CLIMA ?? previo.U_MGS_CL_CLIMA),
              ...
              ");
                WriteLiteral(@"      U_MGS_CL_EXSER: toNumberOrZero(previo.u_MGS_CL_EXSER ?? previo.U_MGS_CL_EXSER),
        ...
        function renderPreviewTabla(dataParaMostrar) {
            ...
            tablaPreviewNuevoBody.innerHTML = filas.map(item => `
                <tr data-tienda=""${item.U_MGS_CL_TIENDA ?? ''}"">
                    <td class=""d-none"">${item.LineId ?? ''}</td>
                    <td class=""sticky-col-start fw-semibold"">${item.U_M");
                WriteLiteral(@"GS_CL_TIENDA ?? ''} - ${item.U_MGS_CL_NOMTIE ?? ''}</td>
                    ...
                    <td contenteditable=""true"" class=""dec"" data-field=""U_MGS_CL_ESTPER"">${formatDecimal(String(item.U_MGS_CL_ESTPER ?? '0'))}</td>
                    ...
                    <td contenteditable=""true"" class=""dec"" data-field=""U_MGS_CL_IMPUES"">${");
                WriteLiteral(@"formatDecimal(String(item.U_MGS_CL_IMPUES ?? '0'))}</td>
                    ...
                    <td contenteditable=""true"" class=""dec"" data-field=""U_MGS_CL_AUOPE"">${formatDecimal(String(item.U_MGS_CL_AUOPE ?? '0'))}</td>
                    ...
                    <td contenteditable=""true"" class=""dec"" data-field=""U_MGS_CL_RUSTI"">$");
                WriteLiteral(@"{formatDecimal(String(item.U_MGS_CL_RUSTI ?? '0'))}</td>
                    ...
                    <td contenteditable=""true"" class=""dec"" data-field=""U_MGS_CL_EXGES"">${formatDecimal(String(item.U_MGS_CL_EXGES ?? '0'))}</td>
        ...
        func");
                WriteLiteral(@"tion aplicarFiltroPreview() {
        ...
        async function abrirModalNuevo() {
            ...
            if (nuevoDescripcion) {
                nuevoDescripcion.textContent = 'Se copiarán los valores del último periodo reg");
                WriteLiteral(@"istrado hacia el siguiente periodo disponible.';
            }
            ...
            //const urlPrevisualizar = `/Factores/Previsualizar?tiendas=${encodeURIComponent(tiendasSeleccionadas.join(','))}`;
            ...
            try {
                ...
                if (!res.ok) {
                    const msg = (data && data.message) ? data.message : `No se p");
                WriteLiteral(@"udo obtener la información (HTTP ${res.status}).`;
        ...
        ");
                WriteLiteral(@"            U_MGS_CL_RENTA: toNumberOrZero(p.U_MGS_CL_RENTA),
                    ...
                    U_MGS_CL_ADM");
                WriteLiteral(@"GR: toNumberOrZero(p.U_MGS_CL_ADMGR),
            ...
            try {
                ...
                modalNuevo?.hide();
                show");
                WriteLiteral(@"Alert(data.message || 'Información cargada correctamente.', 'success');
        ...
        const FIELD_MAP = {
            ...
            '");
                WriteLiteral(@"u_MGS_CL_RENTA': 'U_MGS_CL_RENTA',
        ...
        document.getElementById('btnActualizarTodo')?.addEventListener('click', asy");
                WriteLiteral(@"nc () => {
            // Recolectar filas
