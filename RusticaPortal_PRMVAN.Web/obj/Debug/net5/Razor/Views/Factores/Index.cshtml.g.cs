#pragma checksum "C:\Desarrollos Rustica\PRM Y VAN\CODEX\Prueba_Codex_Proy\RusticaPortal_PRMVAN.Web\Views\Factores\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "a95cdfe78356d4738bb28be195e16fd7d3db9e8f"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"a95cdfe78356d4738bb28be195e16fd7d3db9e8f", @"/Views/Factores/Index.cshtml")]
      ...
      ");
        ...
        document.getElementById('btnBuscar')?.addEventListener('click', async () => {
            ...
            try {
                ...
                const tbody = document.querySelector('#tablaMatriz t");
                WriteLiteral(@"body');
        ...
        function renderFila(m) {
            ...
            return `
                <tr data-id=""${m.lineId}"" data-lineid=""${m.lineId ?? ''}"" data-docentry=""${m.docEntry ?? ''}"" data-periodo=""${m.u_MGS_CL_PERIODO ?? ''}"" data-t");
                WriteLiteral(@"ienda=""${m.u_MGS_CL_TIENDA ?? ''}"" data-nomtien=""${m.u_MGS_CL_NOMTIE ?? ''}"">
        ...
        <td contenteditable=""true"" class=""dec"" data-field=""u_MGS_CL_IMPUES"">${m.u_MGS_CL");
                WriteLiteral(@"_IMPUES ?? ''}</td>
        ...
        <td contenteditable=""true"" c");
                WriteLiteral(@"lass=""dec"" data-field=""u_MGS_CL_EXGES"">${m.u_MGS_CL_EXGES ?? ''}</td>
        ...
        const FIELD_MAP = {
            ...
            'u_MGS_C");
                WriteLiteral(@"L_VAN': 'U_MGS_CL_VAN',
        ...
        document.getElementById('btnActualizarTodo')?.addEventListener('click', async () => {
            // Recolectar filas
           ");
                WriteLiteral(@" const rows = Array.from(document.querySelectorAll('#tablaMatriz tbody tr'));
            if (!rows.length) {
