#pragma checksum "C:\Desarrollos Rustica\PRM Y VAN\CODEX\Prueba_Codex_Proy\RusticaPortal_PRMVAN.Web\Views\Factores\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "2c57f4a179891f605220ffda012814617942b58a"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"2c57f4a179891f605220ffda012814617942b58a", @"/Views/Factores/Index.cshtml")]
            ...
            WriteLiteral(@"p input-group-sm"">
                ...
                <div class=""table-responsive"" style=""max-height:60vh; overflow:auto;"">
                    <table class=""table table-sm table-hover table-bordered"" id=""tablaPreviewNuevo"" style=""white-space:nowrap;"">
                        <thead class=""table-light"">
                            <tr>
                                <th style=""min-width:110px;"">Cód.<br />interno</th>
  ...
  ");
   ...
   ");
        ...
        function renderPreviewTabla(dataParaMostrar) {
            ...
            tablaPreviewNuevoBody.innerHTML = filas.map(item => `
                <tr data-tienda=""${item.U_MGS_CL_TIENDA ?? ''}"">
                    <td>${item.LineId ?? ''}</td>
                    <td class=""sticky-col-start fw-semibold"">${item.U_MGS_CL_TIENDA ??");
                WriteLiteral(@" ''} - ${item.U_MGS_CL_NOMTIE ?? ''}</td>
                    ...
                    <td contenteditable=""true"" class=""dec"" data-field=""U_MGS_CL_IMPUES"">${formatDecimal(S");
                WriteLiteral(@"tring(item.U_MGS_CL_IMPUES ?? '0'))}</td>
                    ...
                    <td contenteditable=""true"" class=""dec"" data-field=""U_MGS_CL_RUSTI"">${formatDecimal(");
                WriteLiteral(@"String(item.U_MGS_CL_RUSTI ?? '0'))}</td>
        ...
        async function abrirModalNuevo() {
            ...
            if (nuevoDescripcion) {
                nuevoDescripcion.textContent = 'Se copiarán los valores del último periodo registrado hacia el si");
                WriteLiteral(@"guiente periodo disponible.';
            }
            ...
            try {
               ...
               ");
                WriteLiteral(@" setNuevoEstado('No se pudo conectar con el servidor.', 'danger');
            }
        }
        ...
        async function crearMatrizDesdeModal() {
            ...
            const payload = {
                ...
                MGS_CL_FACDETCollection: previewData.map(p => ({
                    ...
                    U_M");
                WriteLiteral(@"GS_CL_VAN: toNumberOrZero(p.U_MGS_CL_VAN),
                    ...
                    U_MGS_CL_EXGES: toNumberOrZ");
                WriteLiteral(@"ero(p.U_MGS_CL_EXGES),
            ...
            try {
             ...
             ");
                WriteLiteral(@"   document.getElementById('btnBuscar')?.click();
            } catch (err) {
     ...
     ");
                WriteLiteral(@"       'u_MGS_CL_ESTPER': 'U_MGS_CL_ESTPER',
        ...
        document.getElementById('btnActualizarTodo')?.addEventListener('click', async () => {
            ...
            const rows = Array.from(docum");
                WriteLiteral(@"ent.querySelectorAll('#tablaMatriz tbody tr'));
            if (!rows.length) {
