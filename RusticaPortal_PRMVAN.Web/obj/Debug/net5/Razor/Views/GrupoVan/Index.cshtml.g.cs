#pragma checksum "C:\Desarrollos Rustica\PRM Y VAN\CODEX\Prueba_Codex_Proy\RusticaPortal_PRMVAN.Web\Views\GrupoVan\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "95b77c2d8b0dee1e64cac4b43391c57d5a9e9641"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"95b77c2d8b0dee1e64cac4b43391c57d5a9e9641", @"/Views/GrupoVan/Index.cshtml")]
...
<div class=""container-fluid"" id=""grupos-van-app"">
    ...
    <div class=""row mt-3"">
        <div class=""col-md-3 mb-3"">
            <div class=""card h-100 shadow-sm"">
                <div class=""card-header"">Tiendas</d");
            WriteLiteral(@"iv>
            ...
            <div class=""card h-100 shadow-sm"">
                ...
                <div class=""card-body d-flex flex-column"">
                    <div class=""row g-2 mb-2"">
                        ...
                        <div class=""col-sm-2"">
           ");
            WriteLiteral(@"                 <input id=""inputPorcentajeGrupo"" type=""number"" class=""form-control"" placeholder=""%"" min=""1"" max=""100"" value=""100"" />
                        </div>
            ...
            <div class=""card h-100 shadow-sm"">
                ...
                <div class=""card-body d-flex flex-column"">
                    <div class=""row g-2 mb-2"">
                        ...
                        <div class=""col-sm-3"">
             ");
            WriteLiteral(@"               <input id=""inputPorcentajeArticulo"" type=""number"" class=""form-control"" placeholder=""%"" min=""1"" max=""100"" value=""100"" />
                        </div>
                        <div class=""col-sm-2 d-grid"">
    ...
    <div class=""modal fade"" id=""modalCambios"" tabindex=""-1"" aria-hidden=""true"">
        <div class=""modal-dialog modal-dialog-centered"">
            ...
            WriteLiteral(@"a-bs-dismiss=""modal"">Volver</button>
...
<style>
    ...
    .fila-activa {
        background-color: #cfe2ff !i");
            WriteLiteral(@"mportant; /* destaca la fila seleccionada sin romper el DOM */
    }
...
<script>
    ...
    overlay.innerHTML = '<div class=""sp");
            WriteLiteral(@"inner-border text-primary"" role=""status""><span class=""visually-hidden"">Cargando...</span></div>';
    ...
    // Evita que los clicks en");
            WriteLiteral(@" controles internos disparen el selector de fila y cierren el dropdown.
    ...
    const seleccionarArticuloDesdeInput = () => {
        ...
        const encontrado = state.articulosMaestro.");
            WriteLiteral(@"find(a => a.ItemCode.toLowerCase() === val.toLowerCase());
    ...
    ");
            WriteLiteral(@"const llenarComboTipos = () => {
    ...
    const actualizarHeader = () => {
        ...
        const nombreGrupo = st");
            WriteLiteral(@"ate.grupoActual?.U_MGS_CL_GRPNOM || state.gruposMaestro.find(m => m.Code === state.grupoActual?.U_MGS_CL_GRPCOD)?.Name || '-';
 ...
 ");
            WriteLiteral(@"           renderArticulos(state.articulosGrupo);
        } else {
            renderArticulos([]);
        }
        actualizarHeader();
    ...
    const cambiarTienda = async (tienda) => {
        ...
        document.getElementById('inputPorcenta");
            WriteLiteral(@"jeArticulo').value = '100';
    ...
    const cargarGruposTienda = async () => {
        ...
        state.gruposTienda.forEach(g => {
            ...
            if (typeo");
            WriteLiteral(@"f g.U_MGS_CL_ACTIVO === 'undefined') g.U_MGS_CL_ACTIVO = 'SI';
        });
    ...
    const renderGrupos = () => {
        ...
        state.gruposTienda.forEach(g => {
            ...
            if (state.pending.grup");
            WriteLiteral(@"os.has(g.rowKey)) tr.classList.add('fila-pendiente');
            ...
            se");
            WriteLiteral(@"lTipo.value = g.U_MGS_CL_TIPO || '';
            ...
            inpPorc.min = '1';
            inpPorc.max = '100';
            inpPorc.className = 'form-control form-control");
            WriteLiteral(@"-sm';
    ...
    ");
            WriteLiteral(@"        btn.onclick = async (ev) => {
                ev.preventDefault();
                ev.stopPropagation();
    ...
    const cargarArticulosGrupo = async () => {
        if (!state.gru");
            WriteLiteral(@"poActual) return;

        const data = await fetchJson(`/GrupoVan/ArticulosPorGrupo?tienda=${state.tiendaActual.PrjCode}&grupo=${state.grupoActual.U_MGS_CL_GRPCOD}`, {}, 'al cargar artículos');
        if (!data) return;
    ...
    const validarArticuloExclusivo = async (codigo) => {
        const data = await fetchJson(`/GrupoVan/ArticuloAsignacion?tienda=${state.tiendaActual.PrjCode}&itemCode=${encodeURIComponent(codigo)}&gru");
            WriteLiteral(@"po=${state.grupoActual.U_MGS_CL_GRPCOD}`, {}, 'al validar artículo');
        if (!data) return false;
    ...
    const renderArticulos = (lista) => {
        ...
        lista.forEach(a => {
            ...
            selTipo.innerHTML = ['<option value="""">Tipo</option>', ...state.tipos.map(t => `<option value=""${t.Code}"">${t.Name}</option>`)].join('');
            ");
            WriteLiteral(@"selTipo.value = a.U_MGS_CL_TIPO || '';
            silenciarPropagacion(selTipo);
            selTipo.onchange = (e) => {
                e.stopPropagation();
            ...
            inpPorc.min = '1';
            inpPorc.max = '100';
            inpPorc.className = 'form-control form-co");
            WriteLiteral(@"ntrol-sm';
...
");
    ...
    const agregarGrupo = () => {
        ...
        const nuevo = {
            ");
            WriteLiteral(@"DocEntry: docEntryBase,
    ...
    ");
            WriteLiteral(@"    const tipoSel = document.getElementById('selectTipoArticulo').value;
        ...
        const nuevo = {
            ...
            U_MGS_CL_GRPCOD: state.grupoActual.U_MGS_CL_GRPCO");
            WriteLiteral(@"D,
    ...
    const actualizarTodo = async () => {
        ...
        const payloadGrupos = {
            items: state.gruposTienda
                .filter(g => state.pending.grupos");
            WriteLiteral(@".has(g.rowKey))
                .map(g => ({
                    DocEntry: g.DocEntry,
                    LineId: g.LineId,
        ...
        const payloadArts = {
            items: state.articulosGrupo
                ...
                .map(a => ({
                    ...
                    U_MGS_CL_ACTIVO: a.U_M");
            WriteLiteral(@"GS_CL_ACTIVO ?? 'SI'
                }))
        };
        ...
        if (payloadGrupos.items.length > 0) {
            const data = await fetchJson(
                ...
                { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify(payloadGrupos) },
                'al guardar grupos'
            );
     ...
     ");
        ...
        if (okGrupos && state.grupoActual && payloadArts.items.length > 0) {
            const data = await fetchJson(
                ...
                { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify(payloadArts) },
 ...
 ");
    ...
    document.addEventListener('DOMContentLoaded', async () => {
        ...
        document.getElementById('inputArt");
            WriteLiteral(@"iculo').onchange = seleccionarArticuloDesdeInput;
