#pragma checksum "C:\Desarrollos Rustica\PRM Y VAN\CODEX\Prueba_Codex_Proy\RusticaPortal_PRMVAN.Web\Views\GrupoVan\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "515b25116123f44d2afd2f313064b670fdeee556"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"515b25116123f44d2afd2f313064b670fdeee556", @"/Views/GrupoVan/Index.cshtml")]
            ...
            <div class=""card h-100 shadow-sm"">
                ...
                <div class=""card-body d-flex flex-column"">
                    <div class=""row g-2 mb-2"">
                        ...
                        <div class=""col-sm-2"">
           ");
            WriteLiteral(@"                 <input id=""inputPorcentajeGrupo"" type=""number"" class=""form-control"" placeholder=""%"" min=""0"" max=""100"" value=""100"" />
                        </div>
            ...
            <div class=""card h-100 shadow-sm"">
                ...
                <div class=""card-body d-flex flex-column"">
                    <div class=""row g-2 mb-2"">
                        ...
                        <div class=""col-sm-3"">
             ");
            WriteLiteral(@"               <input id=""inputPorcentajeArticulo"" type=""number"" class=""form-control"" placeholder=""%"" min=""0"" max=""100"" value=""100"" />
                        </div>
                        <div class=""col-sm-2 d-grid"">
...
<script>
    ...
    const silenciarPropagacion = ");
            WriteLiteral(@"(el) => ['click', 'mousedown', 'touchstart', 'focus'].forEach(evt => el.addEventListener(evt, e => e.stopPropagation()));
    ...
    const seleccionarArticuloDesdeInput = () => {
        ...
        state.articuloMaestroSeleccionado = en");
            WriteLiteral(@"contrado || null;
    ...
    const llenarComboTipos = () => {
        const opciones = ['<option value="""">Tipo</option>', ...state.tip");
            WriteLiteral(@"os.map(t => `<option value=""${t.Code}"">${t.Name}</option>`)];
    ...
    const actualizarHeader = () => {
        ...
        document.getElementById('he");
            WriteLiteral(@"aderGrupo').textContent = nombreGrupo || '-';
    ...
    const seleccionarTienda = (tienda) => {
        if (pendientesTotal() > 0) {
            ...
            document.getElementById('btnDescartar').onclick = async () => {
                ...
                modal.hide();
         ");
            WriteLiteral(@"       cambiarTienda(tienda);
            };
            modal.show();
            return;
        }
    ...
    const ");
            WriteLiteral(@"descartarYRecargar = async () => {
        limpiarPendientes();
    ...
    const renderGrupos = () => {
     ...
     ");
            WriteLiteral(@"       if (state.pending.grupos.has(g.rowKey)) tr.classList.add('fila-pendiente');
            ...
            selTipo.innerHTML = ['<option value="""">Tipo</option>', ...state.tipos.map(t => `<option value=""${t.Code}"">${t.Name}</option>");
            WriteLiteral(@"`)].join('');
    ...
    const cambiarGrupo = async (grupo) => {
        if (!grupo.U_MGS_CL_GRPNOM) {
            grupo.U_MGS_CL_GRPNOM = state.gruposMaestro.find(m => m.Code ");
            WriteLiteral(@"=== grupo.U_MGS_CL_GRPCOD)?.Name || '';
        }
    ...
    const cargarArticulosGrupo = async () => {
      ...
      ");
            WriteLiteral(@"      if (typeof a.U_MGS_CL_GRPCOD === 'undefined') a.U_MGS_CL_GRPCOD = state.grupoActual.U_MGS_CL_GRPCOD;
        });
        ...
        state.articulosGrupo.forEach(a => {
            ...
            if (typeof a.U_MGS_CL_TIPO === 'unde");
            WriteLiteral(@"fined') a.U_MGS_CL_TIPO = '';
        });
    };
    ...
    const confirmarDesactivarGrupo = async (grupo) => {
        ...
        if (info?.TieneArticulos) {
            ...
            return await confirmarModal({
                ...
                detalle: 'Si continúas, se eliminaran también los artículos vinculados a este grupo ");
            WriteLiteral(@"en la tienda seleccionada.',
    ...
    const renderArticulos = (lista) => {
        const tbody = document.q");
            WriteLiteral(@"uerySelector('#tablaArticulos tbody');
        tbody.innerHTML = '';
        const info = document.getElementById('infoArticulos');
        ...
        lista.forEach(a => {
            ...
            const tdNombre = document.createElement('td'); tdNo");
            WriteLiteral(@"mbre.textContent = a.U_MGS_CL_ITEMNAM;
...
");
    ...
    const actualizarTodo = async () => {");
        ...
        if (state.grupoActual && payloadArts.items.length > 0) {
            const data = await fetchJson(
 ");
            WriteLiteral(@"               `/GrupoVan/GuardarArticulosPorGrupo?tienda=${state.tiendaActual.PrjCode}&grpCode=${state.grupoActual.U_MGS_CL_GRPCOD}`,
    ...
    document.addEventListener('DOMContentLoaded', async () => {
        ...
        document.getElementById('btnAgregarGrupo'");
            WriteLiteral(@").onclick = (e) => { e.preventDefault(); e.stopPropagation(); agregarGrupo(); };
        ...
        if (!dataTipos) return;
        if (!dataTipos.registered) { mostrarAlerta(dataTipos.");
            WriteLiteral(@"message || 'No se pudieron cargar los tipos VAN'); return; }
