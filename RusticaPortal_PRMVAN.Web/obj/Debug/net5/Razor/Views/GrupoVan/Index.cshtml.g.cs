#pragma checksum "C:\Desarrollos Rustica\PRM Y VAN\CODEX\Prueba_Codex_Proy\RusticaPortal_PRMVAN.Web\Views\GrupoVan\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "5449d0c4e08e9769d1f6250e84f60cf3faa674b6"
// <auto-generated/>
#pragma warning disable 1591
[assembly: global::Microsoft.AspNetCore.Razor.Hosting.RazorCompiledItemAttribute(typeof(AspNetCore.Views_GrupoVan_Index), @"mvc.1.0.view", @"/Views/GrupoVan/Index.cshtml")]
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"5449d0c4e08e9769d1f6250e84f60cf3faa674b6", @"/Views/GrupoVan/Index.cshtml")]
    ...
    public class Views_GrupoVan_Index : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        #pragma warning disable 1998
        public async override global::System.Threading.Tasks.Task ExecuteAsync()
        {
#nullable restore
#line 1 "C:\Desarrollos Rustica\PRM Y VAN\CODEX\Prueba_Codex_Proy\RusticaPortal_PRMVAN.Web\Views\GrupoVan\Index.cshtml"
...
<div class=""container-fluid"" id=""grupos-van-app"">
    <div class=""d-flex align-items-center justify-content-between bg-light border rounded p-3 sticky-top"" style=""top: 70px; z-index: 1030;"">
        ...
        <div class=""d-flex align-items-center gap-3"">
            ...
            <button id=""btnCopiarTienda"" class=""btn btn-outline-secondary"">Copiar a tienda</button>
    ...
    <div class=""row mt-3"">
        ...
        <div class=""col-md-5 mb-3"">
            ...
            WriteLiteral(@"/select>
                        ...
                        <div class=""col-sm-2"">
                            <input id=""inputPorcentajeGrupo"" type=""number"" class=""form-control"" placeholder=""%"" min=""1"" max=""100"" value=""100"" />
                        </div>
            ...
            <div class=""card h-100 shadow-sm"">
                ...
                <div class=""card-body d-flex flex-column"">
                    <div class=""row g-2 mb-2"">
                        ...
                        <div class=""col-sm-3"">
                            <select id=""selectTipoArticulo"" class=""form-select""></s");
            WriteLiteral(@"elect>
                        </div>
                        <div class=""col-sm-3"">
                            <input id=""inputPorcentajeArticulo"" type=""number"" class=""form-control"" placeholder=""%"" min=""1"" max=""100"" value=""100"" />
                        </div>
                        <div class=""col-sm-2 d-grid"">
                ...
                <div class=""modal-body"">
                    <div class=""d-flex gap-2"">
                        <div class=""fs-4 text-warning"">
                            <i c");
            WriteLiteral(@"lass=""bi bi-exclamation-triangle""></i>
                        </div>
                        <div>
    ...
    <div class=""modal fade"" id=""modalCopiarTienda"" tabindex=""-1"" aria-hidden=""true"">
        <div class=""modal-dialog modal-dialog-");
            ...
            <div class=""modal-content shadow"">
                <div class=""modal-header"">
                    <h5 class=""modal-title"">Copiar configuración a tienda</h5>
                    <button type=""button"" class=""btn-close"" data-bs-dismiss=""modal"" aria-label=""Cerrar""></button>
                </div>
                <div class=""modal-body"">
                    <div class=""mb-3"">
                        <label class=""form-label"">Tienda origen</label>
                        <select class=""form-select"" id=""selectTiendaOrigen""></select>
                    </div>
                    <div>
                        <label class=""form-label"">Tienda destino</label>
                        <select class=""form-select"" id=""selectTiendaDestino""></select>
                    </div>
                    <div class=""alert alert-warning d-flex align-items-center gap-2 mt-3 mb-0"" role=""alert"">
                        <i class=""bi bi-exclamation-triangle""></i>
                        <div>Se reem");
            WriteLiteral(@"plazará la información en la tienda destino.</div>
                    </div>
                    <div id=""copyAlert"" class=""alert d-none mt-3 mb-0"" role=""alert""></div>
                </div>
                <div class=""modal-footer"">
                    <button type=""button"" class=""btn btn-outline-secondary"" data-bs-dismiss=""modal"">Cancelar</button>
                    <button type=""button"" class=""btn btn-primary"" id=""btnEjecutarCopia"">Sí, copiar</button>
                </div>
            </div>
        </div>
    </div>
...
<script>
    ...
    overlay.innerHTML = '<div class=""spinner-border text-primary"" ro");
            WriteLiteral(@"le=""status""><span class=""visually-hidden"">Cargando...</span></div>';
    ...
    // Evita que los clicks en controles internos disparen ");
            WriteLiteral(@"el selector de fila y cierren el dropdown.
  ...
  ");
    ...
    const seleccionarArticuloDesdeInput = () => {
        ...
        const encontrado = state.articulosMaestro.find(a => a.ItemCode.toLowerC");
            WriteLiteral(@"ase() === val.toLowerCase());
    ...
    const obtenerPorcentajeValido = (input) => {
        const valor = parseFloat(input.value);
        if (!Number.isFinite(valor) || valor < 1 || valor > 100) {
            mostrarAlerta('El porcentaje debe estar entre 1 y 100');
            return null;
        }
        return valor;
    };
    ...
    const actualizarHeader = () => {
        ...
        const nombreGrupo = state.grupoActual?.U_MGS_CL_GRP");
            WriteLiteral(@"NOM || state.gruposMaestro.find(m => m.Code === state.grupoActual?.U_MGS_CL_GRPCOD)?.Name || '-';
    ...
    const showCopyAlert = (message, type = 'warning') => {
        const alertEl = document.getElementById('copyAlert');
        if (!alertEl || !message) return;
        alertEl.className = `alert ale");
            WriteLiteral(@"rt-${type} mt-3 mb-0`;
        alertEl.textContent = message;
        alertEl.classList.remove('d-none');
    };

    const clearCopyAlert = () => {
        const alertEl = document.getElementById('copyAlert');
        if (!alertEl) return;
        alertEl.textContent = '';
    ...
    const setEstadoBotonCopia = (loading) => {
        const btn = document.getElementById('btnEjecutarCopia');
        if (!btn) return;
        if (loading) {
            btn.disabled = true;
            btn.dataset.originalText = btn.dataset.originalText || btn.innerHTML;
            btn.innerHTML = '<span class=""spinner-border spinner-border-sm me-2"" role=""status"" aria-hidden=""true""></span>Sí, copiar';
        } else {
            btn.disa");
    ...
    const cambiarTienda = async (tienda) => {
        ...
        document.getElementById('articuloSele");
            WriteLiteral(@"ccionado').textContent = '';
        renderSugerenciasArticulos();
    ...
    const cargarGruposTienda = async () => {
        ...
        if (state.gruposTienda.length === 0) {
            mostrarAlerta('No hay grupos activos para la tienda', 'info');
        }
    ...
    const renderGrupos = () => {
        ...
        state.gruposTienda.forEach(g => {
            ...
            if (state.grupoActual?.rowKey === g.rowKey) {
                ...
                ");
            WriteLiteral(@"tr.classList.add('table-primary');
            }
            ...
            selTipo.onchange = (e) => {
                e.stopPropagation();
                g.U");
            WriteLiteral(@"_MGS_CL_TIPO = e.target.value;
                g.U_MGS_CL_ACTIVO = 'SI';

                const inp = tr.querySelector('input[data-lineid=""' + g.LineId + '-grupo""]');
                if (inp) {
                    const porcActual = obtenerPorcentajeValido(inp);
                    if (porcActual === null) return;
                    g.U_MGS_CL_PORC = porcActual;
                }
            ...
            inpPor");
            WriteLiteral(@"c.onchange = (e) => {
                e.stopPropagation();
                const porcActual = obtenerPorcentajeValido(e.target);
                if (porcActual === null) {
                    e.target.value = g.U_MGS_CL_PORC ?? '';
                    return;
                }
                g.U_MGS_CL_PORC = porcActual;
                g.U_MGS_CL_ACTIVO = 'SI';
            ...
            btn.onclick = async (ev) => {
                ...
                const idx = state.gruposTienda.findIndex(x => ");
            WriteLiteral(@"x.rowKey === g.rowKey);
                if (idx < 0) return;
    ...
    const cambiarGrupo = async (grupo) => {
        ...
        if (!grupo.U_MGS_CL_GRPNOM) {
            grupo.U_MGS_C");
            WriteLiteral(@"L_GRPNOM = state.gruposMaestro.find(m => m.Code === grupo.U_MGS_CL_GRPCOD)?.Name || '';
        }
    ...
    const cargarArticulosGrupo = async () => {
        ...
        const data = await fetchJson(`/GrupoVan/ArticulosPorGrupo?tienda=${state.tiendaActual.PrjCode}&grupo=${state.grupoActual.U_MGS_CL_GRPCOD}`, {}, 'al car");
            WriteLiteral(@"gar artículos');
        if (!data) return;
        ...
        if (state.articulosGrupo.length > 0 && ");
            WriteLiteral(@"!tieneCampos) {
            state.camposTipoPorcDisponibles = false;
        }
    ...
    const confirmarDesactivarGrupo = async (grupo) => {
        ...
        const data = await fetchJson(`/GrupoVan/ArticulosActivosPorGrupo?tienda=${state.tiendaActual.PrjCode}&grupo=${grupo.U_MGS_CL_GRPCOD}`, {}, 'al validar artículos del grupo');
        ...
        if (info?.TieneArticulos) {
            const cant = info?.Cantidad || 0;
            return await confirmarModal({
                titulo: 'Desactivar grupo VAN',
                mensaje: `Este grupo tiene  artículo(s) asociado(s).`,
                //mensaje: `Este grupo tiene ${cant} artículo(s) asociado(s).`,
                detalle: 'Si continúas, se eliminaran tambié");
            WriteLiteral(@"n los artículos vinculados a este grupo en la tienda seleccionada.',
    ...
    const validarArticuloExclusivo = async (codigo) => {
        const data = await fetchJson(`/GrupoVan/ArticuloAsignacion?tienda=${state.tiendaActual.PrjCode}&itemCode=${encodeURIComponent(codigo)}&grupo=${state.grupoActual.U_MGS_CL_GRPCOD}`, {}, 'al validar artículo');
        if (!data) return false;

        if (!data.registered) {
            mostrarAlerta(data.message || 'No se pudo validar el artículo');
            return false;
        }

        const info = JSON.parse(data.content || '{}');
        if (info?.Existe) {
            mostrarAlerta(`El artículo ya está asignado al grupo ${info.GrupoCodigo}. No puede repetirse en otra asignación de la misma tienda.`);
            return false;
        }
        return true;
    };
    ...
    const renderArticulos = (lista");
        ...
        lista.forEach(a => {
            ...
            const tdNom");
            WriteLiteral(@"bre = document.createElement('td'); tdNombre.textContent = a.U_MGS_CL_ITEMNAM;
            ...
            selTipo.onchange = (e) => {
                ...
                if (inp) {
                    const porcActual = obtenerPorcentajeValido(inp);
                    if (porcActual === null) return;
                    a.U_MGS_CL_PORC = porcActual;
                }

                ma");
            WriteLiteral(@"rcarPendiente('articulos', a.rowKey);
                tr.classList.add('fila-pendiente');
            };
            tdTipo.appendChild(selTipo);
            ...
            inpPorc.onchange = (e) => {
                ...
                const porcActual = obtenerPorcentajeValido(e.target);
                if (porcActual === null) {
                    e.target.value = a.U_MGS_CL_PORC ?? '';
                    return;
                }
                a.U_MGS_CL_PORC = porcActual;
                a.U_MGS_CL_ACTIVO = 'SI';
                marcarPendiente('arti");
            WriteLiteral(@"culos', a.rowKey);
                tr.classList.add('fila-pendiente');
            };
            tdPorc.appendChild(inpPorc);
            ...
            btn.onclick = (ev) => {
                ...
                if (a.DocEntry) {
                    ...
                    target._toDelete = !marcadoEliminar;
                    target.U_MGS_CL_ACTIVO = marcadoEliminar ? 'S");
            WriteLiteral(@"I' : 'NO';
    ...
    const agregarGrupo = () => {
        ...
        const porcSel = obtenerPorcentajeValido(porcInput);
        if (porcSel === null) return;

  ");
            WriteLiteral(@"      if (!grp) return;
        ...
        const nuevo = {
            ...
            U_MGS_CL_TIPO: tipoSel,
            U_MGS_CL_PORC: porcSel,
            U_MGS_CL_ACTIVO: 'SI'
        };
        ...
        document.getElementById('selectGrupoMaestro').value = '';
        document.getElementById('selectTipoG");
            WriteLiteral(@"rupo').value = '';
        document.getElementById('inputPorcentajeGrupo').value = '100';
    };
    ...
    const agregarArticulo = async () => {
        ...
        const valido = await validarArticuloExclusivo(codigo);
        if (!valido) return;
        ...
        document.getElementById");
            WriteLiteral(@"('inputArticulo').value = '';
        document.getElementById('selectTipoArticulo').value = '';
        document.getElementById('inputPorcentajeArticulo').value = '100';
        renderSugerenciasArticulos();
    };
    ...
    const actualizarTodo = async () => {
      ...
      ");
        ...
        if (payloadGrupos.items.some(g => !Number.isFinite(Number(g.U_MGS_CL_PORC)) || Number(g.U_MGS_CL_PORC) < 1 || Number(g.U_MGS_CL_PORC) > 100)) {
            mostrarAlerta('El porcentaje debe estar entre 1 y 100');
            return;
        }
        ...
        if (payloadGrupos.items.length > 0) {
            const data = await fetchJson(
                `/GrupoVan/GuardarGruposPorTienda?prjCode=${state.tiendaActual.PrjCode}`,
 ");
            WriteLiteral(@"               { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify(payloadGrupos) },
                'al guardar grupos'
            );
            ...
            if (!data.registered) {
                okGrupos = false;
                mostrarAlerta(`Error al guardar grupos: ${data.message || 'No se pudieron actualizar los grupos'}`);
                return;
            }
        ...
        if (payloadArts.items.some(a => !Number.isFinite(Number(a.U_MGS_CL_PORC)) || Number(a.U_MGS_CL_PORC) < 1 || Number(a.U_MGS_CL_PORC) > 100)) {
            mostrarAlerta('El porcentaje debe estar entre 1 y 100');
            return;
        }

        if (okGrupos && state.grupoActual && payloadArts.items.length > 0) {
            const data = await fetchJson(
                `/GrupoVan/GuardarArticulosPorGrupo?tienda=${state.tiendaActual.PrjCode}&grpCode=${state.grupoActual.U_MGS_CL_GRPCOD}`,
                { method");
            WriteLiteral(@": 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify(payloadArts) },
                'al guardar artículos'
            );

            if (!data) return;
            if (!data.registered) {
                okArticulos = false;
                mostrarAlerta(`Error al guardar artículos: ${data.message || 'No se pudieron actualizar los artículos'}`);
                return;
            }
    ...
    const copiarConfiguracion = async () => {
        ...
        if (!ori");
            WriteLiteral(@"gen || !destino) {
            showCopyAlert('Selecciona tienda origen y destino para copiar.', 'warning');
            return;
        }

        if (origen === destino) {
            showCopyAlert('La tienda origen y destino no pueden ser la misma.', 'warning');
            return;
        }

        setEstadoBotonCopia(true);

        try {
            const resp = await fetch(
                `/GrupoVan/CopiarTienda`,
                { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify({ tiendaOrigen: origen, tiendaDestino: destino }) }
            );

            if (!resp.ok) {
                let message = 'Error al copiar configuración.';
                try {
                ...
                showCopyAlert(message, 'danger');
                setEst");
            WriteLiteral(@"adoBotonCopia(false);
                return;
            }

            const data = await resp.json().catch(() => null);
            if (!data) {
                showCopyAlert('Error de conexión al copiar configuración.', 'danger');
                setEstadoBotonCopia(false);
                return;
            }
            if (!data.registered) {
                showCopyAlert(data.message || 'No se pudo copiar configuración.', 'warning');
                setEstadoBotonCopia(false);
                return;
            }

            showCopyAlert('Configuración copiada con éxito.', 'success');
            await new Promise(resolve => setTimeout(resolve, 700));

            const modalEl = document.getElementById('modalCopiarTienda');
            const modal = bootstrap.Modal.getInstance(modalEl);
            modal?.hide();

            const tiendaDestino = state.tiendas.find(t => t.PrjCode === destino);
            if (tiendaDestino) {
                await cambiarTienda(tiendaDes");
            WriteLiteral(@"tino);
            } else {
                await cargarTiendas();
            }
            ...
            limpiarPendientes();
            document.getElementById('selectTiendaOrigen').value = '';
            document.getElementById('selectTiendaDestino').value = '';
            clearCopyAlert();
        } catch (err) {
            showCopyAlert('Error de conexión al copiar configuración.', 'danger');
        } finally {
    ...
    document.addEventListener('DOMContentLoaded', async () => {
        ...
        document.getElementById('btnCopiarTienda");
            WriteLiteral(@"').onclick = async () => {
            if (pendientesTotal() > 0) {
                const modal = new bootstrap.Modal(document.getElementById('modalCambios'));
                document.getElementById('btnDescartar').onclick = async () => {
                    await descartarYRecargar();
        ...
        document.getElementById('btnEjecutarCopia').onclick = copiarConfiguracion;
        const modalCopiarEl = document.getElementById('modalCopiarTienda');
        modalCopiarEl.addEventListener('show.bs.modal', clearCopyAlert);
        modalCopiarEl.addEventListener('hidden.bs.modal', clearCopyAlert);

        document.getElementById('inputArticulo').oninput = (e) => { buscarArticulosMaestro(e.target.value); seleccionarArticuloDesdeInput(); };
        document.getElementById('inputArticulo').onchange = s");
            WriteLiteral(@"eleccionarArticuloDesdeInput;

        const dataTipos = await fetchJson(`/GrupoVan/Tipos`, {}, 'al cargar tipos');
        if (!dataTipos) return;
        if (!dataTipos.registered) { mostrarAlerta(dataTipos.message || 'No se pudieron cargar los tipos VAN'); return; }
        ...
        select.innerHTML = '<option value="""">Grupo VAN</option>' +
