#pragma checksum "C:\Desarrollos Rustica\PRM Y VAN\CODEX\Prueba_Codex_Proy\RusticaPortal_PRMVAN.Web\Views\PrevisionGastos\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "a332ec840e14662690c27bae173728124ad51f9a"
// <auto-generated/>
#pragma warning disable 1591
[assembly: global::Microsoft.AspNetCore.Razor.Hosting.RazorCompiledItemAttribute(typeof(AspNetCore.Views_PrevisionGastos_Index), @"mvc.1.0.view", @"/Views/PrevisionGastos/Index.cshtml")]
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"a332ec840e14662690c27bae173728124ad51f9a", @"/Views/PrevisionGastos/Index.cshtml")]
    ...
    public class Views_PrevisionGastos_Index : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<RusticaPortal_PRMVAN.Web.Models.PrevisionGastosViewModel>
    {
        private static readonly global::Microsoft.AspNetCore.Razor.TagHelpers.TagHelperAttribute __tagHelperAttribute_0 = new global::Microsoft.AspNetCore.Razor.TagHelpers.TagHelperAttribute("rel", new global::Microsoft.AspNetCore.Html.HtmlString("stylesheet"), global::Microsoft.AspNetCore.Razor.TagHelpers.HtmlAttributeValueStyle.DoubleQuotes);
        private static readonly global::Microsoft.AspNetCore.Razor.TagHelpers.TagHelperAttribute __tagHelperAttribute_1 = new global::Microsoft.AspNetCore.Razor.TagHelpers.TagHelperAttribute("href", new global::Microsoft.AspNetCore.Html.HtmlString("~/css/prevision-gastos.css"), global::Microsoft.AspNetCore.Razor.TagHelpers.HtmlAttributeValueStyle.DoubleQuotes);
        #line hidden
        ...
        {
#nullable restore
#line 2 "C:\Desarrollos Rustica\PRM Y VAN\CODEX\Prueba_Codex_Proy\RusticaPortal_PRMVAN.Web\Views\PrevisionGastos\Index.cshtml"
  
    Layout = "_Layout";
    ViewData["Title"] = "Previsión de gastos";

#line default
#line hidden
#nullable disable
            WriteLiteral("\r\n");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("link", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.SelfClosing, "a332ec840e14662690c27bae173728124ad51f9a4025", async() => {
            }
            );
...
<div class=""app-content-header"">
    <div class=""container-fluid"">
        <div class=""row align-items-center"">
            <div class=""col-sm-6"">
                <h3 class=""mb-0"">Previsión de gastos</h3>
            </div>
            <div class=""col-sm-6"">
                <ol class=""breadcrumb float-sm-end"">
                    <li class=""breadcrumb-item""><a href=""/Home/Index"">Home</a></li>
                    <li class=""breadcrumb-item active"" aria-current=""page"">Previsión de gastos</li>
                </ol>
            </div>
        </div>
    </div>
...
<div class=""app-content"" id=""prevision-gastos-app"">
    <div class=""container-fluid"">
        <div class=""card"">
                ...
                <div class=""row g-2 align-items-end"">
                    <div class=""col-auto"">
                        ...
                        <div class=""input-group input-group-sm"">
                            <button class");
            WriteLiteral(@"=""btn btn-outline-secondary"" type=""button"" id=""btnPeriodoAnterior"">
                                <i class=""bi bi-chevron-left""></i>
                            </button>
                            <input type=""month"" id=""filtroPeriodo"" class=""form-control form-control-sm""");
            BeginWriteAttribute("value", " value=\"", 1509, "\"", 1537, 1);
#nullable restore
#line 36 "C:\Desarrollos Rustica\PRM Y VAN\CODEX\Prueba_Codex_Proy\RusticaPortal_PRMVAN.Web\Views\PrevisionGastos\Index.cshtml"
WriteAttributeValue("", 1517, Model.PeriodoActual, 1517, 20, false);
...
#nullable disable
            ...
            WriteLiteral(@"          <div id=""tiendasListado"" class=""d-grid gap-1""></div>
                    ...
                    <div class=""col-auto ms-auto d-flex gap-2"">
                        <div class=""d-flex align-items-center gap-1"">
                            ...
                            <");
            WriteLiteral(@"span class=""badge bg-warning text-dark"" id=""pendingBadge"">0</span>
                        </div>
            ...
            <div class=""card-body p-0"">
                ...
                <div id=""loadingOverlay"" class=""loading-overlay d-none"">
                    <div class=""loading-box text-center"">
                        <div class=""spinner");
            WriteLiteral(@"-border text-primary"" role=""status"">
                ...
                <div class=""table-responsive"" style=""overflow:auto;"">
                    <table class=""table table-sm table-hover table-bordered mb-0 align-middle"" id=""tablaPrevision"" style=""white-space:nowrap;"">
    ...
    <div class=""modal fade"" id=""modalCambios"" tabindex=""-1"" aria-hidden=""true"">
       ...
       ");
            WriteLiteral(@"             <button type=""button"" class=""btn btn-danger"" id=""btnDescartar"">Sí, descartar</button>
                </div>
            </div>
        </div>
    </div>
...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        ...
        const connectionMessage = 'Sin conexión / No se pudo cargar la información. Intente nuevamente.';
        ...
        const elements = {
            ...
            btnSelT");
            WriteLiteral(@"odas: document.getElementById('tiendaSelTodas'),
            btnLimpiar: document.getElementById('tiendaLimpiar'),
            btnTiendasDropdown: document.getElementById('tiendasDropdownBtn'),
            ...
            modalCambios: document.getElemen");
            WriteLiteral(@"tById('modalCambios'),
        ...
        const pick = (obj, keys) => {
            return keys.map(key => obj?.[key]).find(value => value !== null && value !== undefined && value !== '');
        };

        const fetchJson = async (url, options = {}) => {
            if (!navigator.onLine) {
                const error = new Error(connectionMessage);
            ...
            try {
                ...
                if (!error.isConnectionError) {
                    const connectionError = new Error(connect");
            WriteLiteral(@"ionMessage);
        ...
        const handleActionWithPending = (action) => {
            clearAlerts();
            if (state.pending.size > 0 && action !== agregarLinea && action !== guardarTodo) {
        ...
        const cargarTiendas = async () => {
            try {
                ...
                const list = unwrapApiData(resp);
                state.tiendas = (Array.isArray(list) ? list : [])
                    .map(tienda => {
                        const codigo = pick(tienda, ['codigo', 'Codigo', 'Code', 'PrjCode', 'prjCode', 'U_MGS_CL_TIENDA', 'u_MGS_CL_TIENDA']);
                        const nombre = pick(tienda, ['nombre', 'Nombre', 'Name', 'PrjName', 'prjName',  'U_MGS_CL_NOMTIE', 'u_MGS_CL_NOMTIE']);
            ...
            WriteLiteral(@"
                ...
                showLoadError('las tiendas');
            }
        };

        const showLoadError = (resource) => {
            showAlert('warning', `Sin conexión / No se pudo cargar ${resource}. Intente nuevamente.`);
        };
        ...
        const cargarConceptos = async () => {
            try {
                ...
                const list = unwrapApiData(resp);
                state.conceptos = (Array.isArray(list) ? list : [])
                    .map(concepto => {
                        const code = pick(concepto, ['code', 'Code', 'Codigo']);
                        const name = pick(concepto, ['name', 'Name', 'Nombre', 'Descripcion', 'descripcion']);
                        if (!code || !name) return null;
                        return { code, name };
                    })
                    .fi");
            WriteLiteral(@"lter(Boolean);
            } catch (error) {
                showLoadError('los conceptos');
            }
        };
        ...
        const cargarMotivos = async () => {
            try {
                ...
                const list = unwrapApiData(resp);
                state.motivos = (Array.isArray(list) ? list : [])
                    .map(motivo => {
                        const code = pick(motivo, ['code', 'Code', 'Codigo']);
                        const name = pick(motivo, ['name', 'Name', 'Nombre', 'Descripcion', 'descripcion']);
                        if (!code || !name) return null;
                        return { code, name };
                    })
                    .filter(Boolean);
        ...
        const renderTiendas = () => {
         ...
         ");
            WriteLiteral(@"   elements.tiendasListado.innerHTML = '';
            if (state.tiendas.length === 0) {
                elements.tiendasEstado.textContent = 'No hay tiendas disponibles.';
                updateTiendasDropdown();
                return;
            }

            elements.tiendasEstado.textContent = '';
            state.tiendas.forEach(tienda => {
                const id = `chk-${tienda.codigo}`;
                const wrapper = document.createElement('div');
                wrapper.className = 'form-check';
                wrapper.innerHTML = `
                    <input class=""form-check-input"" type=""checkbox"" value=""${tienda.codigo}"" id=""${id}"" checked>
                    <label class=""form-check-label"" for=""${id}"">${tienda.codigo} - ${tienda.nombre}</label>
                `;
        ...
        const renderMotivos = () => {
            ...
            elements.filtroMotivo.value = 'TODOS';
            state.lastMotivo = 'TODOS';
        };

        const updateTiendasDropdown = () => {
            if (!elements.btnTiendasDropdown) return;
            const total = elements.tiendasListado.querySelectorAll('input[type=""checkbox""]').length;
            const selected = elements.tiendasListado.querySelectorAll('input[type=""checkbox""]:checked').length;
            if (total === 0) {
                elements.btnTiendasDropdown.textConten");
            WriteLiteral(@"t = 'Seleccionar tiendas';
                return;
            }
            if (selected === 0) {
                elements.btnTiendasDropdown.textContent = 'Sin tiendas';
                return;
            }
            if (selected === total) {
                elements.btnTiendasDropdown.textContent = 'Todas';
                return;
            }
            elements.btnTiendasDropdown.textContent = `${selected} seleccionadas`;
        };
        ...
        const buscar = async () => {
            if (!navigator.onLine) {
                showAlert('warning', connectionMessage);
                return;
            } cambiarPeriodo

            const periodo = elements.periodo.value;
     ");
            WriteLiteral(@"       if (!periodo) {
            ...
            try {
                const data = await fetchJson(`/PrevisionGastos/Buscar?periodo=${encodeURIComponent(`${elements.periodo.value}-01`)}&tiendas=${encodeURIComponent(tiendas)}&motivo=${encodeURIComponent(motivo)}`);
                const rows = Array.isArray(data?.items) ? data.items : (Array.isArray(data) ? data : []);
                state.docEntry = data?.docEntry || rows[0]?.DocEntry || '';
                state.rows = rows.map(item => ({
                    LineId: item.lineId,
                    U_MGS_CL_TIENDA: item.u_MGS_CL_TIENDA,
                  ");
            WriteLiteral(@"  U_MGS_CL_CONPRM: item.u_MGS_CL_CONPRM,
                    U_MGS_CL_TIPMOP: item.u_MGS_CL_TIPMOP,
                    U_MGS_CL_ITEMCOD: item.u_MGS_CL_ITEMCOD,
                    U_MGS_CL_FECHA: item.u_MGS_CL_FECHA,
                    U_MGS_CL_IMPORT: item.u_MGS_CL_IMPORT,
                    U_MGS_CL_NOVALI: item.u_MGS_CL_NOVALI,
        ...
        const agregarLinea = () => {
            ...
            const tiendasSeleccionadas = Array.from(element");
            WriteLiteral(@"s.tiendasListado.querySelectorAll('input[type=""checkbox""]:checked'))
                .map(chk => chk.value);
        ...
        const renderTable = () => {
            ...
            if (state.rows.length === 0) {
                ...
                tr.innerHTML = '<td colsp");
            WriteLiteral(@"an=""8"" class=""text-center text-muted"">Sin datos</td>';
            ...
            WriteLiteral(@"} - ${m.name}`
                ...
                const validoChecked = (row.U_MGS_CL_NOVALI || 'NO') === 'SI';
                ...
                tr.innerHTML = `
                    ...
                    <td>
             ");
            WriteLiteral(@"           <input type=""text"" class=""form-control form-control-sm input-inline input-item"" list=""listaItems"" data-field=""U_MGS_CL_ITEMCOD"" value=""${escapeHtml(row.U_MGS_CL_ITEMCOD || '')}"" autocomplete=""off"" />
                    </td>
                    <td>
                    ...
                    <td class=""text-center"">
                        <input type=""checkbox"" class=""form-check-input"" data-field=""U_MGS_CL_NOVALI"" ${validoChecked ? 'checked' : ''} />
                    </td>
                `;
                ...
                const fechaInput");
            WriteLiteral(@" = tr.querySelector('[data-field=""U_MGS_CL_FECHA""]');
        ...
        const handleTableChange = (event) => {
            ...
            if (field === 'U_MGS_CL_NOVALI') {
                value = target.checked ? 'SI' : 'NO';
                row[field] = value;
            } else if (field === 'U_MGS_CL_IMPORT') {
                ...
                if (!isFechaValida(value)) {
                    ...
                    targe");
            WriteLiteral(@"t.classList.remove('celda-invalida');
                }
            } else {
                row[field] = value;
            }
        ...
        const handleItemSearch = debounce(async (event) => {
            ...
            try {
                const resp = await fetchJson(`/PrevisionGastos/Items?search=${encodeURIComponent(query)}`);
                const list = unwr");
            WriteLiteral(@"apApiData(resp);
                state.itemsCache = (Array.isArray(list) ? list : [])
                    .map(item => {
                        const code = pick(item, ['itemCode', 'ItemCode', 'Codigo']);
                        const name = pick(item, ['itemName', 'ItemName', 'Nombre', 'Descripcion', 'descripcion']);
                        if (!code || !name) return null;
                        return { code, name };
                    })
                    .filter(Boolean);
        ...
        const guardarTodo = async () => {
            ...
            const payload = {
             ...
             ");
            WriteLiteral(@"       U_MGS_CL_TIPMOP: row.U_MGS_CL_TIPMOP || '',
                    ...
                    U_MGS_CL_NOVALI: row.U_MGS_CL_NOVALI || 'NO'
                }))
            };
            ...
            try {
                ...
                showAlert('success', 'Informació");
            WriteLiteral(@"n actualizada correctamente.');
                await buscar();
            } catch (error) {
                showAlert('warning', connectionMessage);
            } finally {
        ...
        const validarAntesGuardar = () => {
            ...
            elements.tablaBody.");
            WriteLiteral(@"querySelectorAll('input[data-field=""U_MGS_CL_IMPORT""]').forEach(input => {
        ...
        const isFechaValida = (fecha, periodo = elements.periodo.va");
            WriteLiteral(@"lue) => {
        ...
        const cambiarPeriodo = (increment) => {
            ...
            if (state.pending.size > 0) {
                requestDiscard(() => {
                    ...
                    elements.periodo.value = state.lastPer");
            WriteLiteral(@"iod;
                });
                return;
            }
  ...
  <tr>
    <td colspan=""8"" class=""text-center text-muted"">Sin datos</td>
        ...
        const init = () => {
            ...
            modalConfirm = window.bootstrap?.Modal ? new bootstrap.Modal(elements.modalCambios) : null;
            ...
            elements.btnSelTodas.addEventListener('click', (event) => {
                ...
                if (shouldConfirm) {
                    requestDiscard(() => {
                        checks.forEach");
            WriteLiteral(@"(chk => { chk.checked = true; });
                        updateSelectedTiendas();
                    });
                    return;
                }
            ...
            elements.tiend");
            WriteLiteral(@"asListado.addEventListener('change', (event) => {
                const target = event.target;
   ...
   ");
            WriteLiteral(@"         elements.tablaBody.addEventListener('input', handleItemSearch);
...
");
        ...
        [global::Microsoft.AspNetCore.Mvc.Razor.Internal.RazorInjectAttribute]
        public global::Microsoft.AspNetCore.Mvc.Rendering.IHtmlHelper<RusticaPortal_PRMVAN.Web.Models.PrevisionGastosViewModel> Html { get; private set; }
    }
}
