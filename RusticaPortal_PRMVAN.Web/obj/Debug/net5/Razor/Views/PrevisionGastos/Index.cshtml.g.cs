#pragma checksum "C:\Desarrollos Rustica\PRM Y VAN\CODEX\Prueba_Codex_Proy\RusticaPortal_PRMVAN.Web\Views\PrevisionGastos\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "4f7bf75ca5870c8bb987e5c478f6170073d630ce"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"4f7bf75ca5870c8bb987e5c478f6170073d630ce", @"/Views/PrevisionGastos/Index.cshtml")]
...
#nullable disable
            WriteLiteral("\r\n");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("link", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.SelfClosing, "4f7bf75ca5870c8bb987e5c478f6170073d630ce4025", async() => {
            }
            );
...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        ...
        const handleFilterChange = (tipo) => {
            ...
            if (tipo === 'periodo') {
                ...
                state.lastMotivo = elements.fil");
            WriteLiteral(@"troMotivo.value;
            }
        };
     ...
     ");
            WriteLiteral(@"           showLoadError('las tiendas');
            }
        };
            ...
            try {
                ...
                state.motivos = (Array.isArray(list) ? list : [])
                    .map(motivo => {
                        ...
                        const name");
            WriteLiteral(@" = pick(motivo, ['name', 'Name', 'Nombre', 'Descripcion', 'descripcion']);
        ...
        const renderTiendas = () => {
           ...
           ");
            WriteLiteral(@"     wrapper.innerHTML = `
        ...
        const renderMotivos = () => {
            ...
            elements.filt");
            WriteLiteral(@"roMotivo.value = 'TODOS';
        ...
        const updateTiendasDropdown = () => {
            ...
            if (total === 0) {
                elements.btnTiendasDropdown.textContent = 'Seleccionar tiendas';
                return;
            }
            if (selected === 0) {
        ...
        const updateSelectedTiendas = () => {
            const selected = A");
            WriteLiteral(@"rray.from(elements.tiendasListado.querySelectorAll('input[type=""checkbox""]:checked'))
                .map(chk => chk.value);
        ...
        const buscar = async () => {
            ...
            try {
                const resp = await fetchJson(`/PrevisionGastos/Buscar?periodo=${encodeURICompone");
            WriteLiteral(@"nt(periodo)}&tiendas=${encodeURIComponent(tiendas)}&motivo=${encodeURIComponent(motivo)}`);
        ...
        const agregarLinea = () => {
            ...
            const tiendasSeleccionadas = Array.from(elements.tiendasListado.querySelectorAll('input[type=""checkbox""]:checked'))
                .map(chk => chk.value);
            const tiendaDefault =");
            WriteLiteral(@" tiendasSeleccionadas[0] || '';
        ...
        const renderTable = () => {
            ...
            WriteLiteral(@"wKey)) {
                ...
                tr.innerHTML = `
                    <td>${index + 1}</td>
      ");
            WriteLiteral(@"              <td class=""sticky-col-start"">
   ...
   ");
            WriteLiteral(@"         const field = target.dataset.field;
     ...
     ");
            WriteLiteral(@"           const value = parseAmount(target.value);
                if (!isNaN(value)) {
        ...
        const renderItemsList = () => {
            ...
            state.itemsCache.forEach(item => {
                const option = docume");
            WriteLiteral(@"nt.createElement('option');
       ...
       ");
            WriteLiteral(@"             LineId: row.LineId ? parseInt(row.LineId, 10) : null,
 ...
 ");
            WriteLiteral(@"                   showAlert('danger', resp?.message || resp?.Message || 'No se pudo guardar la información.');
                    return;
                }
        ...
        const validarAntesGuardar = () => {
            ...
            elements.tablaBody.querySelectorAll('input[data-field=""U_MGS_CL_FE");
            WriteLiteral(@"CHA""]').forEach(input => {
        ...
        const clearPending = () => {
            state.pending.clear();
            updatePendingBadge();
            elements.tablaBody.querySelectorAll('tr').forEach(tr => tr.classList.re");
            WriteLiteral(@"move('fila-pendiente'));
        };
   ...
   ");
            WriteLiteral(@"         elements.periodo.addEventListener('change', () => handleFilterChange('periodo'));
       ...
       ");
            ...
            wind");
            WriteLiteral(@"ow.addEventListener('beforeunload', (event) => {
                if (state.pending.size > 0) {
                    event.preventDefault();
                    event.returnValue = '';
                }
