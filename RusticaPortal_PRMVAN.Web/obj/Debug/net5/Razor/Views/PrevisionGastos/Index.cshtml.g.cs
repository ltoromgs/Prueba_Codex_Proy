#pragma checksum "C:\Desarrollos Rustica\PRM Y VAN\CODEX\Prueba_Codex_Proy\RusticaPortal_PRMVAN.Web\Views\PrevisionGastos\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "6c60faa5b860b314ea8a7d1d0f99afb2551cc7d1"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"6c60faa5b860b314ea8a7d1d0f99afb2551cc7d1", @"/Views/PrevisionGastos/Index.cshtml")]
...
#nullable disable
            WriteLiteral("\r\n");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("link", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.SelfClosing, "6c60faa5b860b314ea8a7d1d0f99afb2551cc7d14025", async() => {
            }
            );
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        const requestDiscard = (action, onCancel) => {
            ...
            elements.modalCambios.addEventListener('hidden.bs.modal', () => {
             ...
             ");
            WriteLiteral(@"       pendingAction = null;
                    if (onCancel) {
                        onCancel();
                    }
                }
        ...
        const updateTiendasDropdown = () => {
            ...
            if (total === 0) {
                elements.btnTiendasDropdown.");
            WriteLiteral(@"textContent = 'Seleccionar tiendas';
                return;
            }
            if (selected === 0) {
        ...
        const buscar = async () => {
          ...
          ");
            ...
            try {
                const resp = await fetchJson(`/PrevisionGastos/Buscar?periodo=${encodeURIComponent(`${elements.periodo.value}-01`)}&tiendas=${encodeURIComponent(tiendas)}&motivo=${encodeURIComponent(motivo)}`);
           ...
           ");
            WriteLiteral(@"     showAlert('warning', connectionMessage);
            } finally {
                setLoading(false);
            }
        };
        ...
        const agregarLinea = () => {
            ...
            const nueva = {
                ...
                U_MGS_CL_IMPORT: 0,
      ");
            WriteLiteral(@"          U_MGS_CL_NOVALI: 'NO',
                isNew: true
            };
        ...
        const renderTable = () => {
            ...
            WriteLiteral(@"${c.code} - ${c.name}`
                ...
                tr.innerHTML = `
                    ...
                    <td>
                        <select class=""");
            WriteLiteral(@"form-select form-select-sm select-inline"" data-field=""U_MGS_CL_TIPMOP"">
                            ${motivoOptions}
                        </select>
                    </td>
                    <td>
            ...
            WriteLiteral(@"orm-check-input"" data-field=""U_MGS_CL_NOVALI"" ${validoChecked ? 'checked' : ''} />
                    </td>
                `;
        ...
        const buildOptions = (items, selectedValue) => {
            ...
            const options = items.map(item => {
                ...
                return `<option value=""${item.value}"" ${selected}>${item.label}</optio");
            WriteLiteral(@"n>`;
            });
        ...
        const guardarTodo = async () => {
            ...
            try {
                ...
                if (resp?.registered === false || resp?.Registered === fa");
            WriteLiteral(@"lse) {
        ...
        const validarAntesGuardar = () => {
            ...
            elements.tablaBody.querySelectorAll('input[data-field=""U_");
            WriteLiteral(@"MGS_CL_FECHA""]').forEach(input => {
        ...
        const clearPending = () => {
            state.pending.clear();
            updatePendingBadge();
            elements.tablaBody.querySelectorAll('tr').forEach(tr => tr.cla");
            WriteLiteral(@"ssList.remove('fila-pendiente'));
        };
       ...
       ");
            WriteLiteral(@"     window.addEventListener('beforeunload', (event) => {
                if (state.pending.size > 0) {
                    event.preventDefault();
                    event.returnValue = '';
                }
