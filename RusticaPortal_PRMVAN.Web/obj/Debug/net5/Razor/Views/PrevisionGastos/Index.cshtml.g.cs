#pragma checksum "C:\Desarrollos Rustica\PRM Y VAN\CODEX\Prueba_Codex_Proy\RusticaPortal_PRMVAN.Web\Views\PrevisionGastos\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "0ffae237cfa081346279124a52401d9541ad87b7"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"0ffae237cfa081346279124a52401d9541ad87b7", @"/Views/PrevisionGastos/Index.cshtml")]
...
#nullable disable
            WriteLiteral("\r\n");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("link", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.SelfClosing, "0ffae237cfa081346279124a52401d9541ad87b74025", async() => {
            }
            );
...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        ...
        const buscar = async () => {
          ...
          ");
            ...
            try {
                ...
                showAlert('warning");
            WriteLiteral(@"', connectionMessage);
            } finally {
                setLoading(false);
            }
        };
        ...
        const renderTable = () => {
            ...
            WriteLiteral(@"-sm select-inline"" data-field=""U_MGS_CL_TIPMOP"">
                            ${motivoOptions}
                        </select>
                    </td>
                    <td>
                    ...
                    <td class=""text-center"">
                        <input type=""checkbox"" class=""form-check-input"" data-f");
            WriteLiteral(@"ield=""U_MGS_CL_NOVALI"" ${validoChecked ? 'checked' : ''} />
                    </td>
                `;
...
");
            WriteLiteral(@"            return emptyOption + options.join('');
        };
        ...
        const handleItemSearch = debounce(async (event) => {
         ...
         ");
            WriteLiteral(@"   if (query.length < 2) return;
        ...
        const guardarTodo = async () => {
            ...
            const payload = {
                ...
                MGS_CL_GASDETCollection: state.rows.map(row => ({
                    LineId: r");
            WriteLiteral(@"ow.LineId ? parseInt(row.LineId, 10) : null,
            ...
            try {
                ...
                if (resp?.registered === false || resp?.Registered === false) {
                    sho");
            WriteLiteral(@"wAlert('danger', resp?.message || resp?.Message || 'No se pudo guardar la información.');
                    return;
                }
        ...
        const defaultFechaPeriodo = (periodo) => {
            ...
            if (hoy >= inicio && hoy <= fin) {
                retu");
            WriteLiteral(@"rn hoy.toISOString().split('T')[0];
            }
        ...
        const cambiarPeriodo = (increment) => {
            ...
            if (state.pending.size > 0) {
                requestDiscard(() => {
   ");
            WriteLiteral(@"                 elements.periodo.value = newValue;
        ...
        const init = () => {
            ...
            elements.peri");
            WriteLiteral(@"odo.addEventListener('change', () => handleFilterChange('periodo'));
    ...
    ");
            ...
            elements.tiendasListado.addEventListener('change', (event) => {
                const target = event.target;
                i");
            WriteLiteral(@"f (target.matches('input[type=""checkbox""]')) {
                    clearAlerts();
                    if (state.pending.size > 0) {
            ...
            WriteLiteral(@"eforeunload', (event) => {
                if (state.pending.size > 0) {
                    event.preventDefault();
                    event.returnValue = '';
                }
