#pragma checksum "C:\Desarrollos Rustica\PRM Y VAN\CODEX\Prueba_Codex_Proy\RusticaPortal_PRMVAN.Web\Views\PrevisionGastos\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "24983b6c8202c5835ae7a224b03fd07a3efdf1f1"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"24983b6c8202c5835ae7a224b03fd07a3efdf1f1", @"/Views/PrevisionGastos/Index.cshtml")]
...
#nullable disable
            WriteLiteral("\r\n");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("link", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.SelfClosing, "24983b6c8202c5835ae7a224b03fd07a3efdf1f14025", async() => {
            }
            );
                    ...
                    <div class=""col-auto"">
                        ...
                        <div class=""dropdown"">
                            ...
                            <div class=""dropdown-menu p-3"" style=""max-height: 280px; overflow: auto; width: 320px;"">
                                ...
                                <div id=""tiend");
            WriteLiteral(@"asListado"" class=""d-grid gap-1""></div>
                    ...
                    <div class=""col-auto ms-auto d-flex gap-2"">
                        <div class=""d-flex align-items-center gap-1"">
                            ...
                            <span class=""badge bg-war");
            WriteLiteral(@"ning text-dark"" id=""pendingBadge"">0</span>
                        </div>
            ...
            <div class=""card-body p-0"">
                ...
                <div id=""loadingOverlay"" class=""loading-overlay d-none"">
                    <div class=""loading-box text-center"">
                        <div class=""spinner-border text-primary"" ro");
        ...
        <div class=""modal-dialog modal-dialog-centered"">
            <div class=""modal-content"">
                ...
                <div class=""modal-footer"">
                    ...
                    <button typ");
            WriteLiteral(@"e=""button"" class=""btn btn-danger"" id=""btnDescartar"">Sí, descartar</button>
                </div>
            </div>
        </div>
    </div>
...
<script>
    ...
    const elements = {
        ...
        btnAct");
            WriteLiteral(@"ualizar: document.getElementById('btnActualizarTodo'),
    ...
    const init = () => {
        ...
        elements.btnSelTodas.addEventListener('click', (event) => {
            ...
            const shouldConfirm =");
            WriteLiteral(@" state.pending.size > 0;
            if (shouldConfirm) {
                requestDiscard(() => {
        ...
        elements.tablaBody.addEventLi");
            WriteLiteral(@"stener('input', handleItemSearch);
    ...
    const requestDiscard = (a");
            WriteLiteral(@"ction, onCancel) => {
        ...
        if (state.pending.size > 0) {
            ...
            requestDiscard(() => {
                ...
                if (tipo === 'periodo') {
                    ...
                    elements.filtroMoti");
            WriteLiteral(@"vo.value = previous;
                }
            });
            return;
        }
  ...
  ");
            WriteLiteral(@"              <label class=""form-check-label"" for=""${id}"">${tienda.PrjCode} - ${tienda.PrjName}</label>
            `;
    ...
    const agregarLinea = () => {
        ...
        const nueva = {
            ...
            U_MGS_CL_ITEMCOD: '',
            U");
            WriteLiteral(@"_MGS_CL_FECHA: fechaDefault,
            U_MGS_CL_IMPORT: 0,
            U_MGS_CL_VALIDO: 'NO',
            isNew: true
        };
    ...
    const renderTable = () => {
        ...
        state.rows.forEach((row, index) => {
            ...
            const conceptoOptions = buildOptions(state.conceptos.map(c => ({
                ...
                label: `${c.Code} - ${c.Name}`
    ");
            WriteLiteral(@"        })), row.U_MGS_CL_CONPRM);
            ...
            tr.innerHTML = `
                ...
                <td>
                    <select c");
            WriteLiteral(@"lass=""form-select form-select-sm select-inline"" data-field=""U_MGS_CL_TIPMOP"">
                        ${motivoOptions}
                    </select>
                </td>
                <td>
    ...
    const handleTab");
     ...
     ");
            WriteLiteral(@"   markPending(rowKey);
    };
...
");
            WriteLiteral(@"        elements.listaItems.innerHTML = '';
    ...
    const guardarTodo = async () => {
        ...
        const payload = {
            ...
            MGS_CL_GAS");
            WriteLiteral(@"DETCollection: state.rows.map(row => ({
        ...
        try {
            ...
            if (resp?.registered === false || resp?.Registered === false) {
                showAlert");
            WriteLiteral(@"('danger', resp?.message || resp?.Message || 'No se pudo guardar la información.');
                return;
            }
    ...
    const validarAntesGuardar = () => {
       ...
       ");
            WriteLiteral(@"     input.classList.toggle('celda-invalida', !isOk);
        });
    ...
    const isFechaValida = (fecha, periodo = elements.periodo.value) => {
        ...
        const [year, ");
            WriteLiteral(@"month] = periodo.split('-').map(Number);
        const inicio = new Date(year, month - 1, 1);
        const fin = new Date(year, month, 0);
    ...
    co");
            WriteLiteral(@"nst fetchJson = async (url, options = {}) => {
